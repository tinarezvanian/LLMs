...
why the architectural alternatives in Chapters~\ref{ch:sparse}--\ref{ch:hybrids} get serious attention now,
...
Chapters~\ref{ch:sparse}--\ref{ch:hybrids} architectures.
