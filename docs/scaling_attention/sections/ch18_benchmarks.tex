\section{Reading the benchmarks honestly}
\label{ch:benchmarks}
...
all of Subquadratic's (SubQ's) numbers in this chapter: \citet{subq2026ssa}. The
...
\subsection{The three benchmarks that matter}
...
\noindent
The paper bundles \emph{thirteen} scored templates across these families
(three single-key, three multi-key, plus multi-value, multi-query,
aggregation, tracing, and QA splits); the table groups them by intent.
...
\subsection{A 13-point checklist for any long-context benchmark report}

Before you take a vendor's RULER or MRCR number at face value, walk down
this list:
