% Numeric citations for manual thebibliography (must precede \documentclass because tufte loads natbib).
...
% --- LLMs scaling-attention note (added after Algorithmic Adventures preamble) ---
\usepackage{amssymb}
