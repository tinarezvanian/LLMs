...
many of the ``new'' subquadratic architectures in Chapters~\ref{ch:sparse}--\ref{ch:hybrids} are direct
...
exams. The transformer ate the field. Chapters~\ref{ch:transformer}--\ref{ch:why-quadratic} are the careful explanation
of why.
...
positions (Chapter~\ref{ch:transformer}).
...
\(4d^{2}\)-ish in the usual \(\mathrm{GeLU}\) configuration). Chapter~\ref{ch:transformer}
