...
\(n^2\) cost carefully; Chapters~\ref{ch:flashattention}--\ref{ch:kv-cache} document the engineering response;
Chapters~\ref{ch:sparse}--\ref{ch:hybrids} cover the architectures that try to escape it.
